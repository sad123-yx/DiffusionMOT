...
class Exp(MyExp):
    def __init__(self):
        ...
        self.train_ann = "train_val.json"
        self.val_ann = "test.json" #"val_half.json"
        ...
        self.det_thresh=0.5
        self.nms_thresh2d=0.7
        self.nms_thresh3d=0.6
        self.interval=5
    ...
    def get_eval_loader(self, batch_size, is_distributed, testdev=False):
        ...
        valdataset = MOTDataset(
            data_dir=os.path.join(dataset_path, "sportsmot"),
