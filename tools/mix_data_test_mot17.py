...
for img in mot_json['images']:
    img['file_name'] = 'mot/train/' + img['file_name']
    img_list.append(img)
...
for img in crowdhuman_json['images']:
    img_id_count += 1
    img['file_name'] = 'crowdhuman/train/' + img['file_name']
...
for img in crowdhuman_val_json['images']:
    img_id_count += 1
    img['file_name'] = 'crowdhuman/val/' + img['file_name']
    img['frame_id'] = img_id_count
    img['prev_image_id'] = img['id'] + max_img
    img['next_image_id'] = img['id'] + max_img
    img['id'] = img['id'] + max_img
...
for img in ethz_json['images']:
    img_id_count += 1
    img['file_name'] = 'ETHZ/' + img['file_name']
    img['frame_id'] = img_id_count
    img['prev_image_id'] = img['id'] + max_img
    img['next_image_id'] = img['id'] + max_img
    img['id'] = img['id'] + max_img
...
cp_json = json.load(open('../datasets/cityperson/annotations/train.json','r'))
img_id_count = 0
for img in cp_json['images']:
    img_id_count += 1
    img['file_name'] = 'cityperson/' + img['file_name']
    img['frame_id'] = img_id_count
    img['prev_image_id'] = img['id'] + max_img
    img['next_image_id'] = img['id'] + max_img
    img['id'] = img['id'] + max_img
