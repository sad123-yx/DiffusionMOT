...
if __name__ == '__main__':
    ...
    image_cnt = 0
    ann_cnt = 0
    folder = os.listdir(DATA_PATH+'images')
    for i in range(0,len(folder)):
        img_folder=folder[i]
        img_folder_path =DATA_PATH+'images/'+img_folder+'/'
        label_folder_path = DATA_PATH+'labels_with_ids/'+img_folder+'/'
