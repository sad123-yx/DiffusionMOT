        ...
        with torch.no_grad():
            ...
            for batch_idx in range(bs//2):
                ...
                fg_mask_pre, is_in_boxes_and_center_pre = self.get_in_boxes_info(
                    ...
                    expanded_strides=32
                )#for caltulate simOTA---fg_mask(foreground mask) anchor point in gt or in gt-expand domain
                ...
                cost_giou = -generalized_box_iou(bz_boxes_pre,bz_boxes_curr,bz_gtboxs_abs_xyxy_pre,bz_gtboxs_abs_xyxy_curr)#calculate box pre and gt Iou
