...
class Trainer:
    ...
    def train_one_iter(self):
        ...
        print("A iter get output and loss time:{} ms".format((iter_mid_time - iter_start_time) * 1000))
        print("A iter cost time:{} ms".format((iter_end_time-iter_start_time)*1000))
        self.meter.update(
